...
import { Check, Edit2, Trash2, RotateCcw, Bell } from 'lucide-react';
import { Task } from '@/types/task';
import { PriorityBadge, CategoryBadge, StatusBadge } from '@/components/ui/Badge';
import { formatDate, formatRelativeTime, formatDateTime } from '@/lib/utils/date';
          ...
          <div className="flex items-start justify-between gap-3 mb-2">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-1">
                ...
                {task.recurring_rule && (
                  <span
                    className="flex items-center gap-1 font-mono text-[10px] text-[#FF6B4A] uppercase tracking-widest"
                    title={`Recurring: ${task.recurring_rule}`}
                  >
                ...
                {task.reminder_at && (
                  <span
                    className="flex items-center gap-1 font-mono text-[10px] text-[#5C4D45] uppercase tracking-widest"
                    title={`Reminder: ${formatDateTime(task.reminder_at)}`}
                  >
