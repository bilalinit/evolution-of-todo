 ...
 * Date: 2026-01-05
 *
 * This file defines the public API contracts for all components in the frontend design.
 * These interfaces ensure type safety and consistent usage across the application.
 */
 ...
 * Contract for auth state passed to navbar and protected components
 */
...
// ============================================================================
// THEME & DESIGN TOKENS INTERFACES
// ============================================================================
...
// Export all interfaces as a single object for easy import
